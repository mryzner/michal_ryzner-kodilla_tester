...
public class HomeworkTest {
    ...
    public void customImageTest() throws InterruptedException, IOException {
        ...
        assertEquals("Michal Ryzner", title);

        /* asercja nie przechodzi z literą ł && trzeba zmienić plik index.html -> Michał na Michal
           trzeba było skasować ApplicationTest bo kolejny plik index np. index2.html powoduje również
           że test nie przechodzi */
    }
}
