public class NotebookApplication {
    public static void main(String[] args) {
        ...
        System.out.println("weight: " + heavyNotebook.getWeight() + " " + "price: " + heavyNotebook.getPrice() + " year: " + heavyNotebook.getYearOfManufacture());
        heavyNotebook.checkPrice();
        heavyNotebook.checkWeight();
        heavyNotebook.checkYearPrice();

        Notebook oldNotebook = new Notebook(1200, 500, 2010);
        System.out.println("weight: " + oldNotebook.getWeight() + " " + "price: " + oldNotebook.getPrice() + " year: " + oldNotebook.getYearOfManufacture());
